...
# >>> ADD: import the Copilot panel (Mini‑GPT)
from copilot_panel import render_copilot
    ...
    if EXPLAIN_MODE:
        ...
        if explain_depth == "Advanced (with formulas)":
            st.latex(r"""
                ...
                \sum_{\mathrm{rows\ in\ cabin}} (\text{Revenue}_{\mathrm{after}} - \text{Revenue}_{\mathrm{before}})
            """)
...
# =========================
# >>> ADD: MINI‑GPT COPILOT PANEL (English)
# =========================
# This *does not* change your visuals. It adds a collapsible chat + auto‑recommendations panel.
render_copilot(df=dff, audience=audience, explain_mode=EXPLAIN_MODE, lang="en")
